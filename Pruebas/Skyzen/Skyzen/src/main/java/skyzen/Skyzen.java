...
public class Skyzen extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Font customFont = Font.loadFont(getClass().getResourceAsStream("/Fonts/soulwayfont-demo.otf"), 14);
        Font customFont2 = Font.loadFont(getClass().getResourceAsStream("/Fonts/futura light bt.ttf"), 14);
        ...
        passwordIcon = new ImageView(new Image(getClass().getResourceAsStream("/AdditionalAssets/eye.png")));
        ...
        userRegisterField.setTranslateY(8);
        ...
        passwordRegisterIn.setTranslateY(-278);
        ...
        passwordRegisterField.setTranslateY(-290);
        ...
        registerIn.setOnAction(e -> {
            ...
            if (newUsername.isEmpty() || newPassword.isEmpty() || newEmail.isEmpty() || !newEmail.contains("@")) {
                mostrarAlerta("Todos los campos de registro deben ser completados correctamente");
    ...
    private void togglePasswordVisibility() {
        ...
        if (passwordVisible) {
            ...
            passwordIcon.setImage(new Image(getClass().getResourceAsStream("/AdditionalAssets/invisible.png")));
        } else {
            passwordField.setText(passwordTextField.getText());
            passwordField.setVisible(true);
            passwordTextField.setVisible(false);
            passwordIcon.setImage(new Image(getClass().getResourceAsStream("/AdditionalAssets/eye.png")));
        }
    }
